...
const windowTitle = "Qt 5 System Tray Example"
...
func main() {
	...
	noVariant := qt.NewQVariant7(int(qt.QSystemTrayIcon__NoIcon))
	infoVariant := qt.NewQVariant7(int(qt.QSystemTrayIcon__Information))
	warningVariant := qt.NewQVariant7(int(qt.QSystemTrayIcon__Warning))
	criticalVariant := qt.NewQVariant7(int(qt.QSystemTrayIcon__Critical))
	...
	trayMenu.AddActions([]*qt.QAction{minimizeAction, maximizeAction, restoreAction})
	trayMenu.AddSeparator()
	trayMenu.AddActions([]*qt.QAction{quitAction})
